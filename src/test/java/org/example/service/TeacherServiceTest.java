...
class TeacherServiceTest {
    ...
    void updateTeacher() {
        ...
        Teacher teacher = new Teacher("engineer", "Bachelor", "4545", new User(new Name("T1", "T1F"), "T1", "5699", Type.Teacher, "+989126666666", "T1@gmail.com", "2222"));
        Teacher teacherBeforeUpdate = teacherService.saveTeacher(teacher);
        String expectedValue = "ssssss@gmail.com";
    ...
    void deleteTeacher() {
        ...
        Teacher teacher = new Teacher("engineer", "Bachelor", "4545", new User(new Name("T1", "T1Family"), "T1", "5699", Type.Teacher, "+989124444444", "T1@gmail.com", "2222"));
    ...
    void addNewLesson() {
        ...
        Teacher teacher = teacherService.saveTeacher(new Teacher("engineer", "Bachelor", "4545", new User(new Name("t1name", "t1family"), "t1nameUserName", "5699", Type.Teacher, "+989125478963", "t1nameemai@gmail.com", "2222")));
    ...
    void getMyStudents() {
        ...
        User user = new User(new Name("Teacher1name", "Teacher1family"), "Teacher1nameUsername", "5699", Type.Teacher, "+981111111111", "Teacher1name1@gmail.com", "2222");
        Teacher teacherR = teacherService.saveTeacher(new Teacher("engineer", "Bachelor", "4545", user));
        teacherR.getLesson().addAll(lessons);
        Teacher teacher1 = teacherService.teacherUpdate(teacherR);


        User userS = new User(new Name("s1name", "s1family"), "s1nameUserName", "5599", Type.Teacher, "+982222222222", "s1name1@gmail.com", "56222");
        Student resultStudent = studentService.saveStudent(new Student("46545", userS));
        resultStudent.getLesson().add(l);
        studentService.studentUpdate(resultStudent);


        User userS1 = new User(new Name("s2name", "s2family"), "s2nameUserName", "5999", Type.Teacher, "+983333333333", "s2name2@gmail.com", "2322");
        Student resultStudent1 = studentService.saveStudent(new Student("4545", userS1));
        resultStudent1.getLesson().add(l1);
        resultStudent1.getLesson().add(l2);
        studentService.studentUpdate(resultStudent1);


        User userS2 = new User(new Name("s3name", "s3family"), "s3nameUserName", "5799", Type.Teacher, "+984444444444", "s3name3@gmail.com", "2422");
